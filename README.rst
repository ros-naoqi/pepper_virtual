...
The package requires pepper_description package

.. code-block:: bash

    sudo apt-get install ros-indigo-pepper-description
...
.. code-block:: bash
    ...
    roslaunch pepper_gazebo_plugin pepper_gazebo_plugin_H25.launch
...
Then you can use moveit as usual : quick tutorial here https://github.com/ros-naoqi/pepper_moveit_config/blob/master/README.rst
